...
if isfunctionhooked then
    if isfunctionhooked(FireServer) or isfunctionhooked(UnreliableFireServer) or isfunctionhooked(InvokeServer) and LPH_OBFUSCATED then
        return Services.LocalPlayer:Kick("chuckyhub.cc | Security : You are running another script, please disable it and execute again")
    end
end
...
getgenv().library = {
    directory = "chuckyhub.cc_remastered",
    folders = {
        "/fonts",
        "/configs",
        "/assets"
